...
import { addProductInBasket, getOneProduct} from '../http/productApi'
    ...
    return (
        <Container className='d-flex justify-content-between'>
            <Col xl={6} md={8} sm={6} className='mt-3' style={{ maxWidth: 450 }} >
                <img src={process.env.REACT_APP_API_URL + product.img} style={{ maxWidth: 450, marginTop: 20 }} alt='omg' />
            </Col>
            <Col xl={6} md={4} sm={6} className='mt-4'>
                <div>
                    <div className='font-weight-bold mb-2' >Пак иконок {product.name}</div>
                    <div><p>Набор включает 4 спрайта персонажей в полный рост, 2 спрайта головы в профиль и горизонтально, и по 1 спрайту со спины.</p></div>
                    ...
                    {Auth ?
                        <>
                            ...
                            <Button className={classes.buttons} style={{ marginTop: '10px' }}  >Купить</Button>
                        </>
